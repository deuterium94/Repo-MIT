...
class EV:
    ...
    def __init__( self, arrivalTime, depTime, chargeNeeded, currentCharge, chargeRate, maxCapacity ):
        self.id = update_vars.numVehiclesMade
        update_vars.numVehiclesMade += 1
        #self.id = poissonGen.numVehiclesMade
        ...
        self.profit              =     ( self.timeToCharge / 60.0) * self.chargeRate * update_vars.electricityPrice

        # return self
    def getProfit(self):
        # print "profit function should return ",(self.timeToCharge / 60.0) * self.chargeRate * common.electricityPrice
        return (self.timeToCharge / 60.0) * self.chargeRate * update_vars.electricityPrice
...
#    def getProfit(self):
#        return (self.timeToCharge / 60.0) * self.chargeRate * electricityPrice
